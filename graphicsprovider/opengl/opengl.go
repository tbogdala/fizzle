...
func (impl *GraphicsImpl) GenerateMipmap(t graphics.Texture) {
...
func (impl *GraphicsImpl) TexImage2D(target graphics.Enum, level, intfmt, width, height, border int32, format graphics.Enum, ty graphics.Enum, ptr unsafe.Pointer) {
...
func (impl *GraphicsImpl) Uniform3fv(location, count int32, value *float32) {
...
func (impl *GraphicsImpl) Uniform4fv(location, count int32, value *float32) {
...
func (impl *GraphicsImpl) UniformMatrix4fv(location, count int32, transpose bool, value *float32) {
